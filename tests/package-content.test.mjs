...
test('R6: the actual npm pack includes runtime files and excludes backups and private evidence', () => {
  ...
  for (const required of ['index.js', 'cordis.patch.yml', 'lib/pass.js', 'lib/mcp/patch-yaml.js', 'scripts/Sync-AuraMcp.mjs', 'scripts/lib/dsh-modules.mjs', 'README.md', 'LICENSE']) {
